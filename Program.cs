    ...
    internal class Program
    {
        public static async Task<int> Main(string[] args) =>
         await Bootstrapper
                ...
                .AddSetting(Keys.Host, "everythinginfo.cloud")
                ...
                .AddSetting("EditLink", Config.FromDocument((doc, ctx) => "https://github.com/everythinginfo/everythinginfo.github.io/edit/develop/input/" + doc.Source.GetRelativeInputPath()))
